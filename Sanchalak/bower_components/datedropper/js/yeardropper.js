              ...
              var _dd_init = function () {
                  ...
                  if (!_dd_settings.animate) {
                    setTimeout(function () {
                      ...
                      _dd
                        ...
                        .scrollLeft(
                          _dd
                            .find('.dd-sub-y li[data-id="' + _dd_sub_y + '"]')
                            .index() * _dd_settings.dropWidth
                        );
                    }, 1);
                ...
                _dd_placement = function () {
                  ...
                  _dd
                    .find(".dd-c")
                    .css({
                      top: _dd_input.offset().top + _dd_input.innerHeight(),
                      // 'left': (_dd_input.offset().left + ((_dd_input.innerWidth() / 2) - (_dd_settings.dropWidth / 3)))
                      left:
                ...
                _dd_construct = function () {
                  _dd.find(".dd-s-b").each(function (index, element) {
                    ...
                    _dd_el.find("ul li").click(function () {
                      if (
                        ...
                        if (_dd_el.hasClass("dd-s-b-m"))
                          _dd_m = parseInt($(this).attr("data-id"));
                        if (_dd_el.hasClass("dd-s-b-d"))
                          _dd_d = parseInt($(this).attr("data-id"));
                  ...
                  _dd.find(".dd-b").each(function (index, element) {
                    ...
                    if (_dd_el.hasClass("dd-y")) {
                      ...
                      _dd_el.find("li").click(function () {
                        if (_dd_settings.format == "Y") return false;
                    ...
                    _dd_el
                      .find("ul")
                      .width(_dd_el.find("li").length * _dd_settings.dropWidth);
                    ...
                    _dd_el.find(".dd-n").click(function () {
                      ...
                      if ($(this).hasClass("dd-n-left")) {
                        ...
                        if (__dd_el.length && __dd_el.is(":visible"))
                          ...
                          y = parseInt(
                            _dd_el.find("li:visible:last").attr("data-id")
                          );
                      } else {
                        __dd_el = _dd_el
                          .find('li[data-id="' + x + '"]')
                    ...
                    var _detect = function () {
                      if (_dd_init_state) {
                        ...
                        var value = parseInt(
                          _dd_el.find("li").eq(_d_ps).attr("data-id")
                        );
                ...
                _dd_set = function () {
                  ...
                  if (_dd.hasClass("dd-init")) {
                    ...
                    (_dd_m = t_m_cur + 1), (_dd_d = t_d_cur), (_dd_y = t_y_cur);
