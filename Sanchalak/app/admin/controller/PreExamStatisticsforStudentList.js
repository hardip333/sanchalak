app.controller('PreExamStatisticsCtrl', function ($scope, $http, $rootScope, $filter, $localStorage, $state, $cookies, $mdDialog, NgTableParams) {
    ...
    $scope.getPreExamStatisticsStudentData = function () {
        //debugger
        var data = {
        ...
        $http({
            method: 'POST',
            url: 'api/PreExamStatisticsforStudentList/PreExamStatisticsforStudentList',
            data: data,
