app.controller('ReportForJrSupervisorCenterWiseCtrl', function ($scope, $http, $rootScope, $localStorage, $state, $cookies, $mdDialog, NgTableParams, $filter) {

    $rootScope.pageTitle = "Report For Jr. Supervisor Center Wise";
    ...
    $scope.ExamVenueGet = function () {
        ...
        $http({
            method: 'POST',
            url: 'api/ReportForJrSupervisorCenterWise/ExamVenueGet',
            data: $scope.JRSP,
    ...
    $scope.ExamEventMasterGet = function () {
        ...
        $http({
            method: 'POST',
            url: 'api/ReportForJrSupervisorCenterWise/ExamEventMasterGet',
            data: $scope.JRSP,
            headers: { "Content-Type": 'application/json' }
        })
            .success(function (response) {
    ...
    $scope.JrSuperVisorReportExamCenterGet = function (ProgInstPTId, InstancePartTermName, PaperName, PaperCode, PaperId, ExamDate, SlotName, StudentCount) {
        ...
        $scope.JRSP.ExamBlock = {};
        $http({
            method: 'POST',
            url: 'api/ReportForJrSupervisorCenterWise/JrSuperVisorReportExamCenterGet',
            data: $scope.JRSP,
            headers: { "Content-Type": 'application/json' }
        })
            .success(function (response) {
    ...
    $scope.ExamBlocksGet = function (JRSPEB) {
        ...
        $scope.JRSPEB.ExamVenueExamCenterId = $scope.JRSP.ExamCenter.ExamVenueExamCenterId;

        $scope.JRSPEB.PaperId = JRSPEB.PaperId;
        $scope.JRSPEB.ProgrammeInstancePartTermId = JRSPEB.ProgInstPTId;
        $scope.JRSPEB.InstancePartTermName = JRSPEB.InstancePartTermName;
        $scope.JRSPEB.PaperName = JRSPEB.PaperName;
        $scope.JRSPEB.PaperCode = JRSPEB.PaperCode;
        $scope.JRSPEB.ExamDate = JRSPEB.ExamDate;
        $scope.JRSPEB.SlotName = JRSPEB.SlotName;
        $scope.JRSPEB.StudentCount = JRSPEB.StudentCount;

        $http({
            method: 'POST',
            url: 'api/ReportForJrSupervisorCenterWise/JrSuperVisorReportExamBlocksGet',
            data: $scope.JRSPEB,
            headers: { "Content-Type": 'application/json' }
        })
            .success(function (response) {
    ...
    /*Get ReportForJrSupervisorCenterWise List1*/
    $scope.GetJrSupervisorReportList1 = function () {
        ...
        if ($scope.JRSP.ExamVenue.Id == null || $scope.JRSP.ExamVenue.Id == "" || $scope.JRSP.ExamVenue.Id === undefined) {
            ...
            $http({
                method: 'POST',
                url: 'api/ReportForJrSupervisorCenterWise/JrSuperVisorReportList1',
                data: $scope.JRSP,
                headers: { "Content-Type": 'application/json' }
            })
                .success(function (response) {
    ...
    /*Get ReportForJrSupervisorCenterWise List2*/
    $scope.GetJrSupervisorReportList2 = function (JRSPEB,a) {
        ...
        $http({
            method: 'POST',
            url: 'api/ReportForJrSupervisorCenterWise/JrSuperVisorReportList2',
            data: $scope.JRSP,
            headers: { "Content-Type": 'application/json' }
        })
            .success(function (response) {
    ...
    $scope.GetBack = function () {
        ...
        $state.go('ReportForJrSupervisorCenterWise');
        $scope.FlagList2 = false;
        $scope.FlagBlockwiseList = false;
    };
        ...
        var mystyleSecond = {
            ...
            caption: {
                title: '<label style=font-size:15px;> Jr.SuperVisor Report on </label>' + DateAndTime + '<br>' +
                    ...
                    'Center Name : ' + $scope.CenterName + '<br>' +
