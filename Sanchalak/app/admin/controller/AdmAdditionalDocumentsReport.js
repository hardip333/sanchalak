app.controller('AdmAdditionalDocumentsReportCtrl', function ($scope, $http, $filter, $localStorage, $rootScope, $state, $cookies, $mdDialog, NgTableParams) {

    $rootScope.pageTitle = "Manage AdmAdditional Documents Report ";

    $scope.AdmAdditionalDocumentsReport = {}

    $scope.exporttoexcel = [

        { columnid: 'AdmApplicationId', title: 'Application Form No.' },
        { columnid: 'FacultyName', title: 'Faculty Name' },
        { columnid: 'ProgrammeName', title: 'Programme Name' },
        { columnid: 'BranchName', title: 'Branch Name' },
        { columnid: 'IsApprovedByFacultys', title: 'Approved By Faculty' },
        { columnid: 'DocFileName', title: 'Document File Name' },
    ];
    ...
    $scope.resetAdmAdditionalDocumentsReport = function () {
        $scope.AdmAdditionalDocumentsReport = {};
    };

    /*Get Application Payment Report*/
    $scope.getAdmAdditionalDocumentsReport = function () {
        //debugger;
        //alert($localStorage.facultyDepartIntituteId);
        //var data = new Object();
        var obj = {

            ProgrammeInstancePartTermId: $scope.AdmAdditionalDocumentsReport.ProgInstPartTermId,
            FacultyId: $localStorage.facultyDepartIntituteId
        }
        console.log(obj);
        $http({
            method: 'POST',
            url: 'api/AdmAdditionalDocumentsReport/AdmAdditionalDocumentsReportGet',
            data: obj,
            ...
            .success(function (response) {
                ...
                if (response.response_code == "0") {
                    ...
                    $scope.AdmAdditionalDocumentsReportTableParams = new NgTableParams({
                            page: 1,
                            count:10
    ...
    $scope.getProgInstPartTerm = function () {
        $http({
            method: 'POST',
            url: 'api/AdmAdditionalDocumentsReport/IncProgrammeInstancePartTermGet',
    ...
    $scope.exportDataFull = function () {
        ...
        var ExcelFileName = "AdmAdditionalDocumentsReport_" + ShortDate + time;
