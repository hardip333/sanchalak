app.controller('SelectedPaperReportCtrl', function ($scope, $http, $rootScope, $localStorage, $state, $cookies, $mdDialog, NgTableParams) {
    $rootScope.pageTitle = "Paper Report";
    ...
    $scope.getFacultyById = function () {
        ...
        $http({
            ...
            .success(function (response) {
                ...
                $scope.SRBP.FacultyId = $scope.Institute.Id;
                $scope.SRBP.InstituteId = $scope.Institute.InstituteId;
                $scope.SRBP.InstituteName = $scope.Institute.InstituteName;
            })
            .error(function (res) {
                alert(res);
            });
