...
{
    public class PendingStatusByFacultyController : ApiController
    {
        ...
        [HttpPost]
        public HttpResponseMessage PendingStatusByFacultyGet(PendingStatusByFaculty PSF)
        {
            try
            {
                ...
                SqlCommand Cmd = new SqlCommand("PendingStatusByFaculty", Con);
                ...
                Int32 count = 0;
                List<PendingStatusByFaculty> ObjLstVF = new List<PendingStatusByFaculty>();

                if (Dt.Rows.Count > 0)
                {
                    for (int i = 0; i < Dt.Rows.Count; i++)
                    {
                        PendingStatusByFaculty ObjVF = new PendingStatusByFaculty();
