...
{
    public class PreVerificationNotApprovedController : ApiController
    {
        ...
        #region PendingforStatusByFacultyGet
        [HttpPost]
        public HttpResponseMessage PendingStatusByFacultyGet(PreVerificationNotApproved PSF)
        {
            try
            {
                ...
                SqlCommand Cmd = new SqlCommand("PreVerificationNotApproved", Con);
                ...
                Int32 count = 0;
                List<PreVerificationNotApproved> ObjLstVF = new List<PreVerificationNotApproved>();

                if (Dt.Rows.Count > 0)
                {
                    for (int i = 0; i < Dt.Rows.Count; i++)
                    {
                        PreVerificationNotApproved ObjVF = new PreVerificationNotApproved();
