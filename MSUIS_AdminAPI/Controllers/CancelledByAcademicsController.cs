...
{
    public class CancelledByAcademicsController : ApiController
    {
        ...
        #region CancelledByAcademicsGet
        [HttpPost]
        public HttpResponseMessage CancelledByAcademicsGet(CancelledByAcademics CASA)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    List<CancelledByAcademics> Clist = new List<CancelledByAcademics>();
                    Int32 count = 0;
                    SqlCommand cmd = new SqlCommand();
                    cmd.Parameters.AddWithValue("@ProgrammeInstancePartTermId", CASA.ProgrammeInstancePartTermId);
                    cmd.CommandText = "CancelledByAcademics";
                    ...
                    {
                        CancelledByAcademics c = new CancelledByAcademics();
                        ...
                        c.IsCancelledByAcademics = Convert.ToBoolean(DR["IsCancelledByAcademics"].ToString());
                        c.CanclledByAcademics = DR["CanclledByAcademics"].ToString();
                        c.AcademicsCancelledOns = DR["AcademicsCancelledOn"].ToString();
                        c.AcademicsCancelledRemark = DR["AcademicsCancelledRemark"].ToString();
