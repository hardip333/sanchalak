...
{
    public class RefundRequestByStudentController : ApiController
    {
        ...
        [HttpPost]
        public HttpResponseMessage RefundRequestByStudentGet(RefundRequestByStudent ObjRefund)
        {
            RefundRequestByStudent modelobj = new RefundRequestByStudent();
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("RefundRequestByStudent", con);
                ...
                sda.Fill(dt);
                Int32 count = 0;
                List<RefundRequestByStudent> ObjRefCase = new List<RefundRequestByStudent>();

                if (dt.Rows.Count > 0)
                {
                    foreach (DataRow dr in dt.Rows)
                    {
                        RefundRequestByStudent ObjRef = new RefundRequestByStudent();
