...
{
    public class VerifiedByFacultyController : ApiController
    {
        ...
        [HttpPost]
        public HttpResponseMessage VerifiedByFacultyGet(VerifiedByFaculty VF)
        {
            try
            {
                ...
                SqlCommand Cmd = new SqlCommand("VerifiedByFaculty", Con);
                ...
                Int32 count = 0;
                List<VerifiedByFaculty> ObjLstVF = new List<VerifiedByFaculty>();

                if (Dt.Rows.Count > 0)
                {
                    for (int i = 0; i < Dt.Rows.Count; i++)
                    {
                        VerifiedByFaculty ObjVF = new VerifiedByFaculty();
