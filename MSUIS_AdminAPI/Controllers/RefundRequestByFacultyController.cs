...
{
    public class RefundRequestByFacultyController : ApiController
    {
        ...
        #region RefundRequestByStudentGet
        [HttpPost]
        public HttpResponseMessage RefundRequestByFacultyGet(RefundRequestByFaculty ObjRefund)
        {
            RefundRequestByFaculty modelobj = new RefundRequestByFaculty();
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("RefundRequestByFaculty", con);
                ...
                sda.Fill(dt);
                Int32 count = 0;
                List<RefundRequestByFaculty> ObjRefCase = new List<RefundRequestByFaculty>();

                if (dt.Rows.Count > 0)
                {
                    foreach (DataRow dr in dt.Rows)
                    {
                        RefundRequestByFaculty ObjRef = new RefundRequestByFaculty();
