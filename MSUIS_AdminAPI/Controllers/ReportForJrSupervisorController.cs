...
{
    public class ReportForJrSupervisorController : ApiController 
    {
        ...
        [HttpPost]
        public HttpResponseMessage JrSuperVisorReportExamBlocksGet(ExamBlocksGet EB)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("JrSuperVisorReportExamBlocksGet", Con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@ExamEventId", ExamEventId);
                cmd.Parameters.AddWithValue("@PaperId", PaperId);
                cmd.Parameters.AddWithValue("@ExamVenueId", ExamVenueId);
                ...
                Da.SelectCommand = cmd;
                Da.Fill(Dt);
                List<JrSupervisorBlockReport> ExamBlock = new List<JrSupervisorBlockReport>();
        ...
        //[HttpPost]
        //public HttpResponseMessage PDFGeneratedForJrSP(JrSupervisor JRS)
        //{
        //    try
        //    {
        //        String token = Request.Headers.GetValues("token").FirstOrDefault();
        ...
        //        PdfReportforJrSP func = new PdfReportforJrSP();

        //        string output = func.GeneratePDFforJrSP(JRS);
