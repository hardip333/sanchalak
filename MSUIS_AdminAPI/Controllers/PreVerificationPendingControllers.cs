...
{
    public class PreVerificationPendingController : ApiController
    {
        ...
        [HttpPost]
        public HttpResponseMessage PendingforVerificationByFacultyGet(PreVerificationPending PVF)
        {
            try
            {
                ...
                SqlCommand Cmd = new SqlCommand("PreVerificationPending", Con);
                ...
                Int32 count = 0;
                List<PreVerificationPending> ObjLstVF = new List<PreVerificationPending>();

                if (Dt.Rows.Count > 0)
                {
                    for (int i = 0; i < Dt.Rows.Count; i++)
                    {
                        PreVerificationPending ObjVF = new PreVerificationPending();
