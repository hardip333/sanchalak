...
{
    public class PendingforVerificationByFacultyController : ApiController
    {
        ...
        #region PendingforVerificationByFacultyGet
        [HttpPost]
        public HttpResponseMessage PendingforVerificationByFacultyGet(PendingforVerificationByFaculty PVF)
        {
            try
            {
                ...
                SqlCommand Cmd = new SqlCommand("PendingforVerificationByFaculty", Con);
                Cmd.CommandType = CommandType.StoredProcedure;


                Cmd.Parameters.AddWithValue("@ProgrammeInstancePartTermId", PVF.ProgrammeInstancePartTermId);
                ...
                Int32 count = 0;
                List<PendingforVerificationByFaculty> ObjLstVF = new List<PendingforVerificationByFaculty>();

                if (Dt.Rows.Count > 0)
                {
                    for (int i = 0; i < Dt.Rows.Count; i++)
                    {
                        PendingforVerificationByFaculty ObjVF = new PendingforVerificationByFaculty();
