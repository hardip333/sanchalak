...
{
    public class ApprovedByAcademicController : ApiController
    {
        ...
        [HttpPost]
        public HttpResponseMessage ApprovedByAcademicGet(ApprovedByAcademic AFR)
        {
            try
            {
                ...
                SqlCommand Cmd = new SqlCommand("ApprovedByAcademicsReport", Con);
                ...
                Int32 count = 0;
                List<ApprovedByAcademic> ObjLstAFR = new List<ApprovedByAcademic>();

                if (Dt.Rows.Count > 0)
                {
                    for (int i = 0; i < Dt.Rows.Count; i++)
                    {
                        ApprovedByAcademic ObjAFR = new ApprovedByAcademic();
