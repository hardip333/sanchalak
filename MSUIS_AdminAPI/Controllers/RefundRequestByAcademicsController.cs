...
{
    public class RefundRequestByAcademicsController : ApiController
    {
        ...
        #region RefundRequestByAcademicsGet
        [HttpPost]
        public HttpResponseMessage RefundRequestByAcademicsGet(RefundRequestByAcademics ObjRefund)
        {
            RefundRequestByAcademics modelobj = new RefundRequestByAcademics();
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("RefundRequestByAcademics", con);
                ...
                sda.Fill(dt);
                Int32 count = 0;
                List<RefundRequestByAcademics> ObjRefCase = new List<RefundRequestByAcademics>();

                if (dt.Rows.Count > 0)
                {
                    foreach (DataRow dr in dt.Rows)
                    {
                        RefundRequestByAcademics ObjRef = new RefundRequestByAcademics();
