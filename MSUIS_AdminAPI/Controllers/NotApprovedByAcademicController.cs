...
{
    public class NotApprovedByAcademicController : ApiController
    {
        ...
        [HttpPost]
        public HttpResponseMessage NotApprovedByAcademicGet(NotApprovedByAcademic AFR)
        {
            try
            {
                ...
                SqlCommand Cmd = new SqlCommand("NotApprovedByAcademicsReport", Con);
                ...
                Int32 count = 0;
                List<NotApprovedByAcademic> ObjLstAFR = new List<NotApprovedByAcademic>();

                if (Dt.Rows.Count > 0)
                {
                    for (int i = 0; i < Dt.Rows.Count; i++)
                    {
                        NotApprovedByAcademic ObjAFR = new NotApprovedByAcademic();
