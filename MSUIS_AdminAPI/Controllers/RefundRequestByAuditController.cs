...
{
    public class RefundRequestByAuditController : ApiController
    {
        ...
        #region RefundRequestByAuditGet
        [HttpPost]
        public HttpResponseMessage RefundRequestByAuditGet(RefundRequestByAudit ObjRefund)
        {
            RefundRequestByAudit modelobj = new RefundRequestByAudit();
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("RefundRequestByAudit", con);
                ...
                sda.Fill(dt);
                Int32 count = 0;
                List<RefundRequestByAudit> ObjRefCase = new List<RefundRequestByAudit>();

                if (dt.Rows.Count > 0)
                {
                    foreach (DataRow dr in dt.Rows)
                    {
                        RefundRequestByAudit ObjRef = new RefundRequestByAudit();
