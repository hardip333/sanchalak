...
{
    public class ApprovedByFacultyController : ApiController
    {
        ...
        #region ApprovedByFacultyReportGet
        [HttpPost]
        public HttpResponseMessage ApprovedByFacultyGet(ApprovedByFaculty AFR)
        {
            try
            {
                ...
                SqlCommand Cmd = new SqlCommand("ApprovedByFacultyReport", Con);
                ...
                Int32 count = 0;
                List<ApprovedByFaculty> ObjLstAFR = new List<ApprovedByFaculty>();

                if (Dt.Rows.Count > 0)
                {
                    for (int i = 0; i < Dt.Rows.Count; i++)
                    {
                        ApprovedByFaculty ObjAFR = new ApprovedByFaculty();
