...
namespace MSUISApi.Models
{
    public class BlankMarksheet
    {
        ...
        public string GenerateBlankMarksheet(BlankMarkSheets dataString)
        {
            int TmpErrorCnt = 0;
            int TmpErrorIndex = -1;
            ...
            try
            {
                ...
                MstPaper objPaper = func1.MstPaperById(dataString.PaperId,"UA",dataString.TeachingLearningMethodId, dataString.AssessmentMethodId);
                if (dataString.TeachingLearningMethodId == 5 && dataString.AssessmentMethodId == 2)
                {
                    ...
                    obj = func.getBlankMarksheetDetailsForUA(dataString);
                    ...
                    {
                        Document doc = new Document(iTextSharp.text.PageSize.A4, 35, 35, 10, 20);
                       ...
                       // PdfContentByte cd = writer.DirectContent;
                        ...
                        for (int i = 1; i <= loop; i++)
                        {
                            ...
                            //    cell = getTableCell("", 3, 1, cellFont, bgColor, 1, solid, null, solid, solid);
                            //    cell.Padding = 5;
                            ...
                            cell = getTableCell(jpg, 3, 1, cellFont, bgColor, 1, solid, null, solid, solid);
                            cell.Padding = 5;
                            tableLayout.AddCell(cell);
                            ...
                            cell = getTableCell(objPaper.AssessmentMethodName + " UA (Max Mark:" + objPaper.MaxMarks + " Min Mark:" + objPaper.MinMarks + ")", 1, 1, cellFont, bgColor, 1, solid, solid, null, solid);
                            cell.PaddingBottom = 7;
                            // cell.HorizontalAlignment = Element.ALIGN_CENTER;
                            tableLayout.AddCell(cell);
                            ...
                            cellFontSmall = new Font(baseFont, 7, Font.NORMAL);
        ...
        public string GenerateBlankMarksheetForIA(BlankMarkSheets dataString)
        {
                       ...
                       string imageURL = "F:/inetpub/wwwroot/MSUIS_AdminAPI/Upload/BlankMarksheet/MSU_Logo.png";
                        ...
                        for (int j = 1; j <= 25; j++)
                        {
                            ...
                            else
                            {
                                ...
                                cell.HorizontalAlignment = Element.ALIGN_LEFT;
                                tableLayout.AddCell(cell);
                                pageDetails = i.ToString() + " " + j.ToString();
            ...
            {
                string ErrorMsg = "Error :" + pageDetails + " ";
                return ErrorMsg + " " + e.Message;
                // Console.WriteLine(e.Message);
            }
        }
